...
elif [ "$TARGET" == "b2gdroid" ]; then
   TARGET="mobile/android/b2gdroid/app/b2gdroid.js"
   PREFS="-D XP_UNIX -D XP_LINUX -D ANDROID -D MOZ_B2G -D MOZ_B2GDROID -D MOZ_WIDGET_ANDROID"
